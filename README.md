...
4. Download the models from http://www.cs.mun.ca/~lourdes/public/PromoTech_models/
5. Uncompress the two Random Forest models with *.zip* format and save them at the [*models* folder](models/). The resulting files are *models/RF-HOT.model* and *models/RF-TETRA.models*
