function PPT21 =KNN2(Name2,testD2)
%KNN 
load F-scorezhiL2_2.mat F1
...
for k=10:10:200
    ...
    for j=1:WNp
        for i=1:M2
            a=0;
            for ii=1:M1
                if strcmp(testD22(j,ii),xp(i,ii))
                    a=a+2;
                else
                    a=a-1;
                end
...
for i=1:17
    k=F1(2,i);
    PPT21(:,i)=w1(:,k);%将正负样本的所有特征按F-score分数进行排序
end
